...
class SemiLocalMixed(
    ...
    """ A condition with resistance to flow between subdomains. Implementation
        of the model proposed by Starnoni et
        al 2020.

    """

    def __init__(self, keyword, discr_master, discr_slave=None):
        super(SemiLocalMixed, self).__init__(keyword)
    ...
    def assemble_matrix_rhs(
        ...
        self.discr_slave.assemble_int_bound_grad_p(
            g_slave, data_slave, data_edge, cc, matrix, rhs, slave_ind
        )
        self.discr_slave.assemble_int_bound_vector_source(
            g_slave, data_slave, data_edge, cc, matrix, rhs, slave_ind
        )
    ...
    def assemble_edge_coupling_via_low_dim(
        ...
        return self.discr_master.assemble_int_bound_grad_p_between_interfaces(
