...
class SemiLocalCoupling(RobinCoupling):
    """A condition with resistance to flow between subdomains, and with transverse
    diffusivity between the normal and tangential directions.

    Implementation of the model proposed by Starnoni et al 2020.
    ...
    def __init__(self, keyword, discr_primary, discr_secondary=None):
        ...
        self.edge_coupling_via_high_dim = True
        # No coupling via lower-dimensional interfaces.
        self.edge_coupling_via_low_dim = True
    ...
    def discretize(
        ...
        faces_h, cells_h, _ = sps.find(g_primary.cell_faces)
        ...
        kt = parameter_dictionary_edge["transverse_diffusivity"]
    ...
    def assemble_edge_coupling_via_low_dim(
        ...
        return self.discr_primary.assemble_int_bound_grad_p_between_interfaces(
            g, data_grid, data_primary_edge, proj_pressure, proj_flux, cc, matrix, rhs
        )
